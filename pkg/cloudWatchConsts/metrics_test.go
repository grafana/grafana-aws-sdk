...
func TestNamespaceMetricsMapIsTheSameAfterTheInitialOrdering(t *testing.T) {
	assert.True(t, compareMapsUnordered(NamespaceMetricsMap, originalNamespaceMetricsMap))
}

// todo: remove after this PR is merged
var originalNamespaceMetricsMap = map[string][]string{
	...
	"AWS/AutoScaling":             {"GroupAndWarmPoolDesiredCapacity", "GroupAndWarmPoolTotalCapacity", "GroupDesiredCapacity", "GroupInServiceCapacity", "GroupInServiceInstances", "GroupMaxSize", "GroupMinSize", "GroupPendingCapacity", "GroupPendingInstances", "GroupStandbyCapacity", "GroupStandbyInstances", "GroupTerminatingCapacity", "GroupTerminatingInstances", "GroupTotalCapacity", "GroupTotalInstances", "PredictiveScalingCapacityForecast", "PredictiveScalingLoadForecast", "PredictiveScalingMetricPairCorrelation", "WarmPoolDesiredCapacity", "WarmPoolMinSize", "WarmPoolPendingCapacity", "WarmPoolTerminatingCapacity", "WarmPoolTotalCapacity", "WarmPoolWarmedCapacity"},
	"AWS/Bedrock":                 {"Invocations", "InvocationLatency", "InvocationClientErrors", "InvocationServerErrors", "InvocationThrottles", "InputTokenCount", "OutputImageCount", "OutputTokenCount"},
	...
	"AWS/Events":                         {"DeadLetterInvocations", "Events", "FailedInvocations", "IngestiontoInvocationCompleteLatency", "IngestiontoInvocationStartLatency", "Invocations", "InvocationAttempts", "InvocationsCreated", "InvocationsFailedToBeSentToDlq", "InvocationsSentToDlq", "MatchedEvents", "PutEventsApproximateFailedCount", "PutEventsApproximateSuccessCount", "PutEventsApproximateThrottledCount", "PutEventsEntriesCount", "PutEventsFailedEntriesCount", "PutEventsLatency", "PutEventsRequestSize", "PutPartnerEventsApproximateCallCount", "PutPartnerEventsApproximateFailedCount", "PutPartnerEventsApproximateSuccessCount", "PutPartnerEventsApproximateThrottledCount", "PutPartnerEventsEntriesCount", "PutPartnerEventsFailedEntriesCount", "PutPartnerEventsLatency", "RetryInvocationAttempts", "SuccessfulInvocationAttempts", "ThrottledRules", "TriggeredRules", "PutEventsApproximateCallCount"},
	...
	"AWS/GameLift":                       {"ActivatingGameSessions", "ActiveGameSessions", "ActiveInstances", "ActiveServerProcesses", "AvailableGameServers", "AvailableGameSessions", "AverageWaitTime", "CurrentPlayerSessions", "CurrentTickets", "DesiredInstances", "DrainingAvailableGameServers", "DrainingUtilizedGameServers", "FirstChoiceNotViable", "FirstChoiceOutOfCapacity", "GameSessionInterruptions", "HealthyServerProcesses", "IdleInstances", "InstanceInterruptions", "LowestLatencyPlacement", "LowestPricePlacement", "MatchAcceptancesTimedOut", "MatchesAccepted", "MatchesCreated", "MatchesPlaced", "MatchesRejected", "MaxInstances", "MinInstances", "PercentAvailableGameSessions", "PercentHealthyServerProcesses", "PercentIdleInstances", "Placement", "PlacementsCanceled", "PlacementsFailed", "PlacementsStarted", "PlacementsSucceeded", "PlacementsTimedOut", "PlayerSessionActivations", "PlayersStarted", "QueueDepth", "RuleEvaluationsFailed", "RuleEvaluationsPassed", "ServerProcessAbnormalTerminations", "ServerProcessActivations", "ServerProcessTerminations", "TicketsFailed", "TicketsStarted", "TicketsTimedOut", "TimeToMatch", "TimeToTicketSuccess", "UtilizedGameServers"},
	"AWS/GlobalAccelerator":              {"NewFlowCount", "ProcessedBytesIn", "ProcessedBytesOut", "HealthyEndpointCount", "UnhealthyEndpointCount"},
	"Glue":                               {"glue.driver.BlockManager.disk.diskSpaceUsed_MB", "glue.driver.ExecutorAllocationManager.executors.numberAllExecutors", "glue.driver.ExecutorAllocationManager.executors.numberMaxNeededExecutors", "glue.driver.aggregate.bytesRead", "glue.driver.aggregate.elapsedTime", "glue.driver.aggregate.numCompletedStages", "glue.driver.aggregate.numCompletedTasks", "glue.driver.aggregate.numFailedTasks", "glue.driver.aggregate.numKilledTasks", "glue.driver.aggregate.recordsRead", "glue.driver.aggregate.shuffleBytesWritten", "glue.driver.aggregate.shuffleLocalBytesRead", "glue.driver.jvm.heap.usage", "glue.ALL.jvm.heap.usage", "glue.driver.jvm.heap.used", "glue.ALL.jvm.heap.used", "glue.driver.s3.filesystem.read_bytes", "glue.ALL.s3.filesystem.read_bytes", "glue.driver.s3.filesystem.write_bytes", "glue.ALL.s3.filesystem.write_bytes", "glue.driver.system.cpuSystemLoad", "glue.ALL.system.cpuSystemLoad", "glue.driver.streaming.numRecords", "glue.driver.streaming.batchProcessingTimeInMs", "glue.driver.system.cpuSystemLoad", "glue.ALL.system.cpuSystemLoad", "glue.driver.skewness.stage", "glue.driver.skewness.job", "glue.succeed.ALL", "glue.error.ALL", "glue.driver.workerUtilization", "glue.driver.memory.heap.available", "glue.driver.memory.heap.used", "glue.driver.memory.heap.used.percentage", "glue.driver.memory.non-heap.available", "glue.driver.memory.non-heap.used", "glue.driver.memory.non-heap.percentage", "glue.driver.memory.total.available", "glue.driver.memory.total.used", "glue.driver.memory.total.used.percentage", "glue.ALL.memory.heap.available", "glue.ALL.memory.heap.used", "glue.ALL.memory.heap.used.percentage", "glue.ALL.memory.non-heap.available", "glue.ALL.memory.non-heap.used", "glue.ALL.memory.non-heap.percentage", "glue.ALL.memory.total.available", "glue.ALL.memory.total.used", "glue.ALL.memory.total.used.percentage", "glue.driver.disk.available_GB", "glue.driver.disk.used_GB", "glue.driver.disk.used.percentage", "glue.ALL.disk.available_GB", "glue.ALL.disk.used_GB", "glue.ALL.disk.used.percentage", "glue.driver.bytesRead", "glue.driver.recordsRead", "glue.driver.filesRead", "glue.driver.partitionsRead", "glue.driver.bytesWritten", "glue.driver.recordsWritten", "glue.driver.filesWritten"},
	...
	"AWS/KinesisAnalytics":               {"backPressuredTimeMsPerSecond", "busyTimeMsPerSecond", "Bytes", "bytes_consumed_rate", "bytesRequestedPerFetch", "committedoffsets", "commitsFailed", "commitsSucceeded", "containerCPUUtilization", "containerDiskUtilization", "containerMemoryUtilization", "cpuUtilization", "currentInputWatermark", "currentoffsets", "currentOutputWatermark", "downtime", "fullRestarts", "heapMemoryUtilization", "idleTimeMsPerSecond", "InputProcessing.DroppedRecords", "InputProcessing.Duration", "InputProcessing.OkBytes", "InputProcessing.OkRecords", "InputProcessing.ProcessingFailedRecords", "InputProcessing.Success", "KPUs", "LambdaDelivery.DeliveryFailedRecords", "LambdaDelivery.Duration", "LambdaDelivery.OkRecords", "lastCheckpointDuration", "lastCheckpointSize", "managedMemoryTotal", "managedMemoryUsed", "managedMemoryUtilization", "millisBehindLatest", "MillisBehindLatest", "numLateRecordsDropped", "numberOfFailedCheckpoints", "numRecordsIn", "numRecordsInPerSecond", "numRecordsOut", "numRecordsOutPerSecond", "oldGenerationGCCount", "oldGenerationGCTime", "Records", "records_lag_max", "Success", "threadCount", "uptime", "zeppelinCpuUtilization", "zeppelinHeapMemoryUtilization", "zeppelinServerUptime", "zeppelinThreadCount", "zeppelinWaitingJobs"},
	...
	"AWS/Lambda":                         {"AsyncEventAge", "AsyncEventsDropped", "AsyncEventsReceived", "ClaimedAccountConcurrency", "ConcurrentExecutions", "DeadLetterErrors", "DestinationDeliveryFailures", "Duration", "Errors", "Invocations", "IteratorAge", "OffsetLag", "OversizedRecordCount", "PostRuntimeExtensionsDuration", "ProvisionedConcurrencyInvocations", "ProvisionedConcurrencySpilloverInvocations", "ProvisionedConcurrencyUtilization", "ProvisionedConcurrentExecutions", "RecursiveInvocationsDropped", "Throttles", "UnreservedConcurrentExecutions"},
	...
	"AWS/MediaLive":                      {"ActiveAlerts", "ActiveOutputs", "ChannelInputErrorSeconds", "ConfiguredBitrate", "ConfiguredBitrateAvailable", "DroppedFrames", "EncoderBitrate", "EncoderRunning", "ErrorSeconds", "FillMsec", "InputLocked", "InputLossSeconds", "InputTimecodesPresent", "InputVideoFrameRate", "LinkedToStreamEndpoint", "NetworkIn", "NetworkOut", "NotRecoveredPackets", "Output4xxErrors", "Output5xxErrors", "OutputAudioLevelDbfs", "OutputAudioLevelLkfs", "PipelinesLocked", "PrimaryInputActive", "RecoveredPackets", "Streaming", "SvqTime", "Temperature", "TotalPackets", "UsingHDMI", "UsingSDI"},
	...
	"AWS/RDS":                            {"ActiveTransactions", "AuroraBinlogReplicaLag", "AuroraGlobalDBDataTransferBytes", "AuroraGlobalDBReplicatedWriteIO", "AuroraGlobalDBReplicationLag", "AuroraReplicaLag", "AuroraReplicaLagMaximum", "AuroraReplicaLagMinimum", "AvailabilityPercentage", "BacktrackChangeRecordsCreationRate", "BacktrackChangeRecordsStored", "BacktrackWindowActual", "BacktrackWindowAlert", "BackupRetentionPeriodStorageUsed", "BinLogDiskUsage", "BlockedTransactions", "BufferCacheHitRatio", "BurstBalance", "CheckpointLag", "ClientConnections", "ClientConnectionsClosed", "ClientConnectionsNoTLS", "ClientConnectionsReceived", "ClientConnectionsSetupFailedAuth", "ClientConnectionsSetupSucceeded", "ClientConnectionsTLS", "CommitLatency", "CommitThroughput", "ConnectionAttempts", "CPUCreditBalance", "CPUCreditUsage", "CPUSurplusCreditBalance", "CPUSurplusCreditsCharged", "CPUUtilization", "DatabaseConnectionRequests", "DatabaseConnectionRequestsWithTLS", "DatabaseConnections", "DatabaseConnectionsBorrowLatency", "DatabaseConnectionsCurrentlyBorrowed", "DatabaseConnectionsCurrentlyInTransaction", "DatabaseConnectionsCurrentlySessionPinned", "DatabaseConnectionsSetupFailed", "DatabaseConnectionsSetupSucceeded", "DatabaseConnectionsWithTLS", "DBLoad", "DBLoadCPU", "DBLoadNonCPU", "DDLLatency", "DDLThroughput", "Deadlocks", "DeleteLatency", "DeleteThroughput", "DiskQueueDepth", "DiskQueueDepthLogVolume", "DMLLatency", "DMLThroughput", "EBSByteBalance%", "EBSIOBalance%", "EngineUptime", "FailedSQLServerAgentJobsCount", "FreeableMemory", "FreeLocalStorage", "FreeStorageSpace", "FreeStorageSpaceLogVolume", "InsertLatency", "InsertThroughput", "LoginFailures", "MaxDatabaseConnectionsAllowed", "MaximumUsedTransactionIDs", "NetworkReceiveThroughput", "NetworkThroughput", "NetworkTransmitThroughput", "OldestReplicationSlotLag", "Queries", "QueryDatabaseResponseLatency", "QueryRequests", "QueryRequestsNoTLS", "QueryRequestsTLS", "QueryResponseLatency", "RDSToAuroraPostgreSQLReplicaLag", "ReadIOPS", "ReadIOPSLogVolume", "ReadLatency", "ReadLatencyLogVolume", "ReadThroughput", "ReadThroughputLogVolume", "ReplicaLag", "ReplicationChannelLag", "ReplicationSlotDiskUsage", "ResultSetCacheHitRatio", "SelectLatency", "SelectThroughput", "ServerlessDatabaseCapacity", "SnapshotStorageUsed", "SwapUsage", "TotalBackupStorageBilled", "TransactionLogsDiskUsage", "TransactionLogsGeneration", "UpdateLatency", "UpdateThroughput", "VolumeBytesUsed", "VolumeReadIOPs", "VolumeWriteIOPs", "WriteIOPS", "WriteIOPSLogVolume", "WriteLatency", "WriteLatencyLogVolume", "WriteThroughput", "WriteThroughputLogVolume"},
	"AWS/IVSRealTime":                    {"DroppedFrames", "PacketLoss", "PublishBitrate", "Publishers", "PublishResolution"},
	...
	"AWS/SageMaker":                      {"Invocation4XXErrors", "Invocation5XXErrors", "InvocationModelErrors", "Invocations", "InvocationsPerCopy", "InvocationsPerInstance", "ModelCacheHit", "ModelDownloadingTime", "ModelLatency", "ModelLoadingTime", "ModelLoadingWaitTime", "ModelSetupTime", "ModelUnloadingTime", "OverheadLatency"},
	"/aws/sagemaker/Endpoints":           {"CPUReservation", "CPUUtilization", "CPUUtilizationNormalized", "DiskUtilization", "GPUMemoryUtilization", "GPUMemoryUtilizationNormalized", "GPUReservation", "GPUUtilization", "GPUUtilizationNormalized", "LoadedModelCount", "MemoryReservation", "MemoryUtilization"},
	"/aws/sagemaker/InferenceComponents": {"CPUUtilizationNormalized", "GPUMemoryUtilizationNormalized", "GPUUtilizationNormalized", "MemoryUtilizationNormalized"},
	"/aws/sagemaker/InferenceRecommendationsJobs": {"ClientInvocations", "ClientInvocationErrors", "ClientLatency", "NumberOfUsers"},
	"AWS/SageMaker/LabelingJobs":                  {"ActiveWorkers", "DatasetObjectsAutoAnnotated", "DatasetObjectsHumanAnnotated", "DatasetObjectsLabelingFailed", "JobsFailed", "JobsSucceeded", "JobsStopped", "TasksAccepted", "TasksDeclined", "TasksReturned", "TasksSubmitted", "TimeSpent", "TotalDatasetObjectsLabeled"},
	"AWS/Sagemaker/ModelBuildingPipeline":         {"ExecutionStarted", "ExecutionFailed", "ExecutionSucceeded", "ExecutionStopped", "ExecutionDuration", "StepStarted", "StepFailed", "StepSucceeded", "StepStopped", "StepDuration"},
	"/aws/sagemaker/ProcessingJobs":               {"CPUReservation", "CPUUtilization", "CPUUtilizationNormalized", "DiskUtilization", "GPUMemoryUtilization", "GPUMemoryUtilizationNormalized", "GPUReservation", "GPUUtilization", "GPUUtilizationNormalized", "MemoryReservation", "MemoryUtilization"},
	"/aws/sagemaker/TrainingJobs":                 {"CPUReservation", "CPUUtilization", "CPUUtilizationNormalized", "DiskUtilization", "GPUMemoryUtilization", "GPUMemoryUtilizationNormalized", "GPUReservation", "GPUUtilization", "GPUUtilizationNormalized", "MemoryReservation", "MemoryUtilization"},
	"/aws/sagemaker/TransformJobs":                {"CPUReservation", "CPUUtilization", "CPUUtilizationNormalized", "DiskUtilization", "GPUMemoryUtilization", "GPUMemoryUtilizationNormalized", "GPUReservation", "GPUUtilization", "GPUUtilizationNormalized", "MemoryReservation", "MemoryUtilization"},
...
// todo: remove after this PR is merged
func compareMapsUnordered(map1, map2 map[string][]string) bool {
	...
	for key, values1 := range map1 {
		...
		valueMap1 := sliceToMap(values1)
		valueMap2 := sliceToMap(values2)

		if !reflect.DeepEqual(valueMap1, valueMap2) {
			return false
		}
	}

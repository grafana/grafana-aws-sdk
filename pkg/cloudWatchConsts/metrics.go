...
var NamespaceDimensionKeysMap = map[string][]string{
	...
	"AWS/Bedrock":                        {"BucketedStepSize", "ImageSize", "ModelId", "Operation", "GuardrailContentSource", "GuardrailPolicyType", "GuardrailArn", "GuardrailVersion", "FindingType", "PolicyArn", "PolicyVersion", "AgentAliasArn"},

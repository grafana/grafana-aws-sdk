...
var NamespaceMetricsMap = map[string][]string{
	...
	"AWS/Kafka": {
		...
		"ConsumerGroupCount",
		"ConsumerGroupOffsetSyncFailure",
		"CpuCreditUsage",
		"CpuIdle",
		"CpuIoWait",
		"CpuSystem",
	...
	"AWS/KinesisAnalytics": {
		...
		"jobmanagerHeapMemoryUtilization",
		"jobmanagerMetaspaceMemoryUtilization",
		"lastCheckpointDuration",
		"lastCheckpointSize",
		"managedMemoryTotal",
		"managedMemoryUsed",
		"managedMemoryUtilization",
		"metaspaceMemoryUtilization",
		"millisBehindLatest",
...
var NamespaceDimensionKeysMap = map[string][]string{
	...
	"AWS/AppStream":                      {"Fleet", "FleetName", "SessionId", "InstanceId", "UserId"},
	...
	"AWS/EC2":                            {"AutoScalingGroupName", "ImageId", "InstanceId", "InstanceType", "Per-VPC Metrics"},
	...
	"AWS/KMS":                            {"KeyId"},
	"AWS/Kafka":                          {"Broker ID", "Cluster Name", "ClusterAlias", "Consumer Group", "Partition", "ReplicatorName", "Topic"},
	...
	"AWS/WorkSpaces":                              {"DirectoryId", "WorkspaceId", "CertificateId", "RunningMode", "BundleId", "ComputeType", "Protocol", "UserName", "ComputerName"},

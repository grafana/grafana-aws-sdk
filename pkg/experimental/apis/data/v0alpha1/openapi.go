...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	...
	"github.com/grafana/grafana-aws-sdk-frankenstein/pkg/backend.DataResponse":                                    schemaDataResponse(ref),
	"github.com/grafana/grafana-aws-sdk-frankenstein/pkg/data.Frame":                                              schemaDataFrame(ref),
	"github.com/grafana/grafana-aws-sdk-frankenstein/pkg/experimental/apis/data/v0alpha1.DataQuery":               schemaDataQuery(ref),
	"github.com/grafana/grafana-aws-sdk-frankenstein/pkg/experimental/apis/data/v0alpha1.QueryTypeDefinitionSpec": schemaQueryTypeDefinitionSpec(ref),
	"github.com/grafana/grafana-aws-sdk-frankenstein/pkg/experimental/apis/data/v0alpha1.DataSourceRef":           schemaDataSourceRef(ref),
	}
}
